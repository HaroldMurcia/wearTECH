...
#-------------------------------------------------------------------------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------------------------------------------------------------------
    #IPHONE
    user1 = np.vstack((ifeat1, ifeat1_1, ifeat1_2, ifeat1_3))

    #IPHONE+MYO
    mUser1 = np.vstack((mfeat1, mfeat1_1, mfeat1_2, mfeat1_3))
...
#-------------------------------------------------------------------------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------------------------------------------------------------------
    #IPHONE
    user2 = np.vstack((ifeat2, ifeat2_1, ifeat2_2, ifeat2_3))

    #IPHONE+MYO
    mUser2 = np.vstack((mfeat2, mfeat2_1, mfeat2_2, mfeat2_3))
#--------------------------------------------------------------------------------------------------------
#-----USER3----------------------------------------------------------------------------------------------
    user = 'eli'
    #CARGAR DATOS
...
#-------------------------------------------------------------------------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------------------------------------------------------------------
    #IPHONE
    user3 = np.vstack((ifeat3, ifeat3_1, ifeat3_2, ifeat3_3))

    #IPHONE+MYO
    mUser3 = np.vstack((mfeat3, mfeat3_1, mfeat3_2, mfeat3_3))
...
#----------------------------------------------------------------------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------------------------------------------------------------------
    #IPHONE
    user4 = np.vstack((ifeat4, ifeat4_1, ifeat4_2, ifeat4_3))

    #IPHONE+MYO
    mUser4 = np.vstack((mfeat4, mfeat4_1, mfeat4_2, mfeat4_3))
#--------------------------------------------------------------------------------------------------------
#-----USER5----------------------------------------------------------------------------------------------
    user = 'tutty'
    #CARGAR DATOS
...
#-------------------------------------------------------------------------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------------------------------------------------------------------
    #IPHONE
    user5 = np.vstack((ifeat5, ifeat5_1, ifeat5_2, ifeat5_3))

    #IPHONE+MYO
    mUser5 = np.vstack((mfeat5, mfeat5_1, mfeat5_2, mfeat5_3))
...
#-------------------------------------------------------------------------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------------------------------------------------------------------
    #IPHONE
    user6 = np.vstack((ifeat6, ifeat6_1, ifeat6_2, ifeat6_3))

    #IPHONE+MYO
    mUser6 = np.vstack((mfeat6, mfeat6_1, mfeat6_2, mfeat6_3))
#----------------------------------------------------------------------------------------------------
#-----USER7----------------------------------------------------------------------------------------------
    user = 'juan'
    #CARGAR DATOS
...
#-------------------------------------------------------------------------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------------------------------------------------------------------
    #IPHONE
    user7 = np.vstack((ifeat7, ifeat7_1, ifeat7_2, ifeat7_3))

    #IPHONE+MYO
    mUser7 = np.vstack((mfeat7, mfeat7_1, mfeat7_2, mfeat7_3))
#----------------------------------------------------------------------------------------------------
#-----USER8----------------------------------------------------------------------------------------------
    user = 'juana'
    #CARGAR DATOS
...
#-------------------------------------------------------------------------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------------------------------------------------------------------
    #IPHONE
    user8 = np.vstack((ifeat8, ifeat8_1, ifeat8_2, ifeat8_3))

    #IPHONE+MYO
    mUser8 = np.vstack((mfeat8, mfeat8_1, mfeat8_2, mfeat8_3))
#---------------------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------------
#CLASIFICACION
    print("-------------------------------------------------------------------")
    ...
    target=np.array([[1,3,4,1,1,3,4,1,1,3,4,1,1,3,4,1,1,3,4,1,1,3,4,1,1,3,4,1,1,3,4,1]]).T
    ...
    file = main_path+'data/LearningData/UJerarquico/DeepL/Normal/iPhone/i_RF.sav'
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/Normal/iPhone/i_SVM.sav'
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/Normal/iPhone/i_NN.sav'
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/Normal/iPhone/i_BDT.sav'
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/Normal/iPhone/i_GAUSS.sav'
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/PCA/iPhone/i_RF.sav'
    pickle.dump(clf_RF, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/PCA/iPhone/i_SVM.sav'
    pickle.dump(clf_SVM, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/PCA/iPhone/i_NN.sav'
    pickle.dump(clf_NN, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/PCA/iPhone/i_BDT.sav'
    pickle.dump(bdt_real, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/PCA/iPhone/i_GAUSS.sav'
    pickle.dump(clf_gauss, open(file, 'wb'))
#-------------------------------------------------------------------------------------------------------------------------------
#-------------------------------------------------------------------------------------------------------------------------------
#IPHONE+MYO
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/Normal/iPhone+Myo/i_m_RF.sav'
    pickle.dump(clf_RF, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/Normal/iPhone+Myo/i_m_SVM.sav'
    pickle.dump(clf_SVM, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/Normal/iPhone+Myo/i_m_NN.sav'
    pickle.dump(clf_NN, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/Normal/iPhone+Myo/i_m_BDT.sav'
    pickle.dump(bdt_real, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/Normal/iPhone+Myo/i_m_GAUSS.sav'
    pickle.dump(clf_gauss, open(file, 'wb'))
    #------------PCA--------------------------------------------------------------------------------------------------------------
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/PCA/iPhone+Myo/i_m_RF.sav'
    pickle.dump(clf_RF, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/PCA/iPhone+Myo/i_m_SVM.sav'
    pickle.dump(clf_SVM, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/PCA/iPhone+Myo/i_m_NN.sav'
    pickle.dump(clf_NN, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/PCA/iPhone+Myo/i_m_BDT.sav'
    pickle.dump(bdt_real, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/UJerarquico/DeepL/PCA/iPhone+Myo/i_m_GAUSS.sav'
    pickle.dump(clf_gauss, open(file, 'wb'))
