...
#CLASIFICACION
    ...
    file = main_path+'data/LearningData/Jerarquico/Normal/iPhone/i_RF.sav'
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/Normal/iPhone/i_SVM.sav'
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/Normal/iPhone/i_NN.sav'
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/Normal/iPhone/i_BDT.sav'
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/Normal/iPhone/i_GAUSS.sav'
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/PCA/iPhone/i_RF.sav'
    pickle.dump(clf_RF, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/PCA/iPhone/i_SVM.sav'
    pickle.dump(clf_SVM, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/PCA/iPhone/i_NN.sav'
    pickle.dump(clf_NN, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/PCA/iPhone/i_BDT.sav'
    pickle.dump(bdt_real, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/PCA/iPhone/i_GAUSS.sav'
    pickle.dump(clf_gauss, open(file, 'wb'))
#-------------------------------------------------------------------------------------------------------------------------------
#-------------------------------------------------------------------------------------------------------------------------------
#IPHONE+MYO
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/Normal/iPhone+Myo/i_m_RF.sav'
    pickle.dump(clf_RF, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/Normal/iPhone+Myo/i_m_SVM.sav'
    pickle.dump(clf_SVM, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/Normal/iPhone+Myo/i_m_NN.sav'
    pickle.dump(clf_NN, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/Normal/iPhone+Myo/i_m_BDT.sav'
    pickle.dump(bdt_real, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/Normal/iPhone+Myo/i_m_GAUSS.sav'
    pickle.dump(clf_gauss, open(file, 'wb'))
    #------------PCA--------------------------------------------------------------------------------------------------------------
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/PCA/iPhone+Myo/i_m_RF.sav'
    pickle.dump(clf_RF, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/PCA/iPhone+Myo/i_m_SVM.sav'
    pickle.dump(clf_SVM, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/PCA/iPhone+Myo/i_m_NN.sav'
    pickle.dump(clf_NN, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/PCA/iPhone+Myo/i_m_BDT.sav'
    pickle.dump(bdt_real, open(file, 'wb'))
    ...
    # save the model to disk
    file = main_path+'data/LearningData/Jerarquico/PCA/iPhone+Myo/i_m_GAUSS.sav'
    pickle.dump(clf_gauss, open(file, 'wb'))
