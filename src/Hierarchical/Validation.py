...
if __name__ == '__main__':
 #----USER1------------------------------------------------------------------
    ...
    #PREDICCIONES
    Pred1_1= predSignal(iup)
    Pred1_2= predSignal(isu)
    Pred1_3= predSignal(iwalk)
    Pred1_4= predSignal(irun)
    Pred1_5= predSignal(icy)
    Pred1_6= predSignal(icar)
    Pred1_7= predSignal(idown)
#########IPHONE########################################################################
    #SUBIENDO ESCALERAS
...
# ------USER2------------------------------------------------------------------------------------
    ...
    #PREDICCIONES
    Pred2_1= predSignal(iup)
    Pred2_2= predSignal(isu)
    Pred2_3= predSignal(iwalk)
    Pred2_4= predSignal(irun)
    Pred2_5= predSignal(icy)
    Pred2_6= predSignal(icar)
    Pred2_7= predSignal(idown)
#########IPHONE########################################################################
    #SUBIENDO ESCALERAS
    is_up,ig_up=valSignal(iup,1)
    feat = sigFeatures(is_up,1)
...
#-----USER3----------------------------------------------------------------------------------------------
    ...
    iwalk, mwalk, irun, mrun, iup, mup, idown, mdown, icar, mcar,isu,msu,icy,mcy = loadData(user,0)
    #PREDICCIONES
    Pred3_1= predSignal(iup)
    Pred3_2= predSignal(isu)
    Pred3_3= predSignal(iwalk)
    Pred3_4= predSignal(irun)
    Pred3_5= predSignal(icy)
    Pred3_6= predSignal(icar)
    Pred3_7= predSignal(idown)
#########IPHONE########################################################################
    #SUBIENDO ESCALERAS
    is_up,ig_up=valSignal(iup,1)
    feat = sigFeatures(is_up,1)
...
#CLASIFICACION
    ...
    #FIRST LEVEL
    #IPHONE
    i_RF= pickle.load(open(main_path+'data/LearningData/Jerarquico/Normal/iPhone/i_RF.sav'))
    i_SVM=pickle.load(open(main_path+'data/LearningData/Jerarquico/Normal/iPhone/i_SVM.sav'))
    i_NN=pickle.load(open(main_path+'data/LearningData/Jerarquico/Normal/iPhone/i_NN.sav'))
    i_BDT_REAL=pickle.load(open(main_path+'data/LearningData/Jerarquico/Normal/iPhone/i_BDT.sav'))
    i_GAUSS=pickle.load(open(main_path+'data/LearningData/Jerarquico/Normal/iPhone/i_GAUSS.sav'))
    #IPHONE+Myo
    i_m_RF= pickle.load(open(main_path+'data/LearningData/Jerarquico/Normal/iPhone+Myo/i_m_RF.sav'))
    i_m_SVM=pickle.load(open(main_path+'data/LearningData/Jerarquico/Normal/iPhone+Myo/i_m_SVM.sav'))
    i_m_NN=pickle.load(open(main_path+'data/LearningData/Jerarquico/Normal/iPhone+Myo/i_m_NN.sav'))
    i_m_BDT_REAL=pickle.load(open(main_path+'data/LearningData/Jerarquico/Normal/iPhone+Myo/i_m_BDT.sav'))
    i_m_GAUSS=pickle.load(open(main_path+'data/LearningData/Jerarquico/Normal/iPhone+Myo/i_m_GAUSS.sav'))
#----------------------------------------------------------------------------------------------
    #SECONDLEVEL
    si_RF= pickle.load(open(main_path+'data/LearningData/Jerarquico/DeepL/Normal/iPhone/i_RF.sav'))
    si_SVM=pickle.load(open(main_path+'data/LearningData/Jerarquico/DeepL/Normal/iPhone/i_SVM.sav'))
    si_NN=pickle.load(open(main_path+'data/LearningData/Jerarquico/DeepL/Normal/iPhone/i_NN.sav'))
    si_BDT_REAL=pickle.load(open(main_path+'data/LearningData/Jerarquico/DeepL/Normal/iPhone/i_BDT.sav'))
    si_GAUSS=pickle.load(open(main_path+'data/LearningData/Jerarquico/DeepL/Normal/iPhone/i_GAUSS.sav'))
    #IPHONE+Myo
    si_m_RF= pickle.load(open(main_path+'data/LearningData/Jerarquico/DeepL/Normal/iPhone+Myo/i_m_RF.sav'))
    si_m_SVM=pickle.load(open(main_path+'data/LearningData/Jerarquico/DeepL/Normal/iPhone+Myo/i_m_SVM.sav'))
    si_m_NN=pickle.load(open(main_path+'data/LearningData/Jerarquico/DeepL/Normal/iPhone+Myo/i_m_NN.sav'))
    si_m_BDT_REAL=pickle.load(open(main_path+'data/LearningData/Jerarquico/DeepL/Normal/iPhone+Myo/i_m_BDT.sav'))
    si_m_GAUSS=pickle.load(open(main_path+'data/LearningData/Jerarquico/DeepL/Normal/iPhone+Myo/i_m_GAUSS.sav'))
#----------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------
        ...
        Pred1=np.concatenate((Pred1_1,Pred2_1,Pred3_1),axis=None)
        Pred2=np.concatenate((Pred1_2,Pred2_2,Pred3_2),axis=None)
        Pred3=np.concatenate((Pred1_3,Pred2_3,Pred3_3),axis=None)
        Pred4=np.concatenate((Pred1_4,Pred2_4,Pred3_4),axis=None)
        Pred5=np.concatenate((Pred1_5,Pred2_5,Pred3_5),axis=None)
        Pred6=np.concatenate((Pred1_6,Pred2_6,Pred3_6),axis=None)
        Pred7=np.concatenate((Pred1_7,Pred2_7,Pred3_7),axis=None)
        iPred=np.concatenate((Pred1,Pred2,Pred3,Pred4,Pred5,Pred6,Pred7),axis=None)
        ...
        itarget = np.concatenate((iA,iB,iC,iD,iE,iG,iH),axis=None)
