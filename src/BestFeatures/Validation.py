...
#CLASIFICACION
    ...
    i_PCA_RF= pickle.load(open(main_path+'data/LearningData/BestD/PCA/iPhone/i_RF.sav'))
    i_PCA_SVM=pickle.load(open(main_path+'data/LearningData/BestD/PCA/iPhone/i_SVM.sav'))
    i_PCA_NN=pickle.load(open(main_path+'data/LearningData/BestD/PCA/iPhone/i_NN.sav'))
    i_PCA_BDT_REAL=pickle.load(open(main_path+'data/LearningData/BestD/PCA/iPhone/i_BDT.sav'))
    i_PCA_GAUSS=pickle.load(open(main_path+'data/LearningData/BestD/PCA/iPhone/i_GAUSS.sav'))
    #---------VALIDACION----------------------------------------------------------------------------------------------------------
...
#IPHONE+MYO
    ...
    #DATOS DE ENTRENAMIENTO
    i_m_PCA_RF= pickle.load(open(main_path+'data/LearningData/BestD/PCA/iPhone+Myo/i_m_RF.sav'))
    i_m_PCA_SVM=pickle.load(open(main_path+'data/LearningData/BestD/PCA/iPhone+Myo/i_m_SVM.sav'))
    i_m_PCA_NN=pickle.load(open(main_path+'data/LearningData/BestD/PCA/iPhone+Myo/i_m_NN.sav'))
    i_m_PCA_BDT_REAL=pickle.load(open(main_path+'data/LearningData/BestD/PCA/iPhone+Myo/i_m_BDT.sav'))
    i_m_PCA_GAUSS=pickle.load(open(main_path+'data/LearningData/BestD/PCA/iPhone+Myo/i_m_GAUSS.sav'))
